...
export function LastHeartbeat({ value, timeZone = "UTC" }: { value: string | null; timeZone?: string }) {
  ...
  return <time dateTime={value} title={formatDateTime(value, timeZone)}>{relative}</time>;
}
